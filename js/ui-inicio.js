      ...
      <div class="today-body">
        ...
        <div class="today-macros">
          <div class="today-macro-row">
            <div class="today-macro-label"><span class="tm-name">Proteína</span><span class="tm-pct">${Math.round(pctProtein)}%</span></div>
            <div class="today-macro-bar-track"><div class="today-macro-bar-fill" data-fill="${pctProtein}%" style="width:0%;"></div></div>
          </div>
          <div class="today-macro-row">
            <div class="today-macro-label"><span class="tm-name">Carboidratos</span><span class="tm-pct">${Math.round(pctCarbs)}%</span></div>
            <div class="today-macro-bar-track"><div class="today-macro-bar-fill" data-fill="${pctCarbs}%" style="width:0%;"></div></div>
          </div>
          <div class="today-macro-row">
            <div class="today-macro-label"><span class="tm-name">Gordura</span><span class="tm-pct">${Math.round(pctFat)}%</span></div>
