import { PROFILE_NAMES, TAB_META, ensureStateShape, loadProfile, store } from './state.js';
...
export function triggerFillAnimations(){
  // thin bars (kcal bar, macro bars, weight progress capsule): animate width from 0 to target
...
export function heroHTML(tab){
  ...
  return `<section class="page-hero">
    <div class="hero-title-row">
      ...
      <h1>${m.title} · ${PROFILE_NAMES[store.currentProfile]}</h1>
    </div>
    <p>${m.subtitle}</p>
  </section>`;
}
